...
import ViewListCourse from "../pages/ViewListCourse/ViewListCourse";
...
export const publicRoutes = [
  ...
  {
    path: PATH_NAME.THANKS,
    element: <Thanks />,
    roles: ["user", "instructor", "student"],
  },
  {
  ...
  {
    path: PATH_NAME.INVOICE,
    element: <Invoice />,
    roles: ["instructor", "student"],
  },
  {
    path: PATH_NAME.PRESS,
  ...
  {
    path: PATH_NAME.PAID_MEMBERSHIP,
  ...
  {
    path: PATH_NAME.OUR_BLOG,
    element: <Blog />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.BLOG_SINGLE_VIEW,
    element: <BlogDetail />,
    roles: ["user", "instructor", "student"],
  },
  {
  ...
  {
    path: PATH_NAME.HELP_VIEW_1,
    element: <HelpView1 />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.HELP_VIEW_2,
    element: <HelpView2 />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.COMPANY_DETAILS,
    element: <Company />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.CAREER,
    element: <Career />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.APPLY_JOB,
    element: <ApplyJob />,
    roles: ["user", "instructor", "student"],
  },
  {
  ...
  {
    path: PATH_NAME.CERTIFICATION_TEST,
    element: <CertificationTest />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.COMING_SOON,
    element: <CommingSoon />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.DOWLOADCOURSE,
    element: <DowloadCourse />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.CERTIFICATION_CENTER,
...
export const privateRoutes = [
  ...
  {
    path: PATH_NAME.EXPLORE,
    element: <Explore />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.LIVE_OUTPUT,
    element: <LiveOutput />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.ADD_LIVE_STREAM,
    element: <AddLiveStream />,
    roles: ["instructor"],
  },
  {
    path: PATH_NAME.ALL_LIVE_STREAM,
    element: <AllLiveStream />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.ALL_INSTRUCTOR_LIST,
    element: <AllInstructor1 />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.HELP,
  ...
  {
    path: PATH_NAME.REPORT_HISTORY,
    element: <ReportHistory />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.SEND_FEEDBACK,
    element: <SendFeedback />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.OTHER_INSTRUCTOR_VIEW,
    element: <OtherInstructorView />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.OTHER_POPULAR_INSTRUCTOR_VIEW,
    element: <OtherPopularInstructorView />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.MY_INSTRUCTOR_PROFILE,
    element: <MyInstructorProfile />,
    roles: ["instructor"],
  },
  {
    path: PATH_NAME.SAVE_COURSES,
    element: <SaveCourses />,
    roles: ["user", "instructor", "student"],
  },
  {
  ...
  {
    path: PATH_NAME.INS_DASHBOARD,
    element: <InsDashboard />,
    roles: ["instructor"],
  },
  {
    path: PATH_NAME.SITEMAP,
    element: <Sitemap />,
    roles: ["user", "instructor", "student"],
  },
  { path: PATH_NAME.EARNING, element: <Earning />, roles: ["instructor"] },
  {
    path: PATH_NAME.PURCHASE_COURSE,
    element: <PurchaseCourse />,
    roles: ["student"],
  },
  {
    path: PATH_NAME.NOTIFICATON,
    element: <Notification />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.VERTIFICATION,
    element: <Vertification />,
    roles: ["user", "instructor", "student"],
  },
  { path: PATH_NAME.PAYOUT, element: <Payout />, roles: ["instructor"] },
  {
    path: PATH_NAME.MESSAGE,
    element: <Message />,
    roles: ["instructor", "student"],
  },
  {
    path: PATH_NAME.COURSES_DETAIL_VIEW,
    element: <CoursesDetailView />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.NEWEST_COURSES_DETAIL_VIEW,
    element: <NewestCoursesDetailView />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.PREVIEWS,
    element: <Previews />,
    roles: ["instructor", "student"],
  },
  { path: PATH_NAME.ANALYTICS, element: <Analytics />, roles: ["instructor"] },
  {
    path: PATH_NAME.CREATE_NEW_COURSE,
    element: <CreateNewCourse />,
    roles: ["instructor"],
  },
  {
    path: PATH_NAME.STD_DASHBOARD,
    element: <StdDashboard />,
    roles: ["student"],
  },
  {
    path: PATH_NAME.MYCERTIFICATIONS,
    element: <MyCertifications />,
    roles: ["instructor", "student"],
  },
  { path: PATH_NAME.CREDIT, element: <Credit />, roles: ["student"] },
  {
    path: PATH_NAME.STATEMENTIS,
    element: <StatementIS />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.STATEMENTST,
    element: <StatementST />,
    roles: ["user", "instructor", "student"],
  },
  {
    path: PATH_NAME.NOTIFICATIONSTUDENT,
    element: <NotificationStudent />,
    roles: ["student"],
  },
  {
    path: PATH_NAME.VIEWlISTCOURSE,
    element: <ViewListCourse />,
    roles: ["student"],
  },
];
