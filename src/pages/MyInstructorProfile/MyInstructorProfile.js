                                                                    ...
                                                                    <div className='fcrse_contents'>
                                                                        <div className="fcrse_content">
                                                                            ...
                                                                            <div className="other_instructor_view-time_view">
                                                                                <span className="view">109k views • </span>
                                                                                <span className="time">15 days ago</span>
                                                                            </div>
                                                                        ...
                                                                        <a href="course_detail_view.html" className="oiv-detail">Complete Python Bootcamp: Go from zero to hero in Python 3</a>
                                                                        <a href="#" className="oiv-career">Web Development | Python</a>
                                                                        <div className="other_instructor_view-publisher">
                                                                            ...
                                                                            <button className="oiv-cart" title="cart"><img src={card_icon} alt='' className='oiv-cart-icon' /></button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div className="oiv-course">
                                                                <div className="oiv-course-detail">
                                                                    ...
                                                                    <div className='fcrse_contents'>
                                                                        ...
                                                                        <a href="course_detail_view.html" className="oiv-detail">The Complete JavaScript Course 2020: Build Real Projects!</a>
                                                                        <a href="#" className="oiv-career">Development | JavaScript</a>
                                                                        <div className="other_instructor_view-publisher">
                                                                            <p className="oiv-publisher">By <a href="#">John Doe</a></p>
                                                            ...
                                                            <div className="oiv-course">
                                                                <div className="oiv-course-detail">
                                                                    ...
                                                                    <div className='fcrse_contents'>
                                                                        ...
                                                                        <a href="course_detail_view.html" className="oiv-detail">WordPress Development - Themes, Plugins &amp; Gutenberg</a>
                                                            ...
                                                            <div className="oiv-course">
                                                                <div className="oiv-course-detail">
                                                                    ...
                                                                    <div className='fcrse_contents'>
                                                                        ...
                                                                        <a href="course_detail_view.html" className="oiv-detail">The Complete Digital Marketing Course - 12 Courses in 1</a>
                                                                        <a href="#" className="oiv-career">Digital Marketing | Marketing</a>
                                                                        <div className="other_instructor_view-publisher">
                                                                            <p className="oiv-publisher">By <a href="#">John Doe</a></p>
                                                                    ...
                                                                    <div className="mip-oiv-course-detail">
                                                                        ...
                                                                        <div className='fcrse_contents'>
                                                                            ...
                                                                            <div className="other_instructor_view-publisher">
                                                                                <p className="oiv-publisher">By <a href="#">John Doe</a></p>
                                                                                <div className="oiv-price">$3</div>
                                                                                <button className="mip-cart" title="cart"><img src={card_icon} alt='' className='oiv-cart-icon' /></button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div className="other_instructor_view-col-lg-12">
                                                            ...
                                                            <div className="oiv-history-comment">
                                                                <div className="oiv-review_item">
                                                                    ...
                                                                    <p className="oiv-cmnt_text_message">Nam gravida elit a velit rutrum, eget dapibus ex elementum. Interdum et malesuada fames ac ante ipsum primis in faucibus. Fusce lacinia, nunc sit amet tincidunt venenatis.</p>
                                                                    <div className="oiv-contact_icon">
                                                                        <a href="#" className="oiv-report"><img src={like} /> 10</a>
                                                                        <a href="#" className="oiv-report"><img src={dislike} /> 1</a>
                                                                        <a href="#" className="oiv-report"><img src={heart} /></a>
                                                                ...
                                                                <div className="oiv-review_reply">
                                                                    <div className="oiv-review_item">
                                                                        <div className="oiv-review_usr_dt">
                                                                            ...
                                                                            <div className="oiv-cmnt_name">
                                                                                <h4 className="oiv-tutor_name">Rock Doe</h4>
                                                                                <span className="oiv-cmnt_time">1 hour ago</span>
                                                                            </div>
                                                                            <div className="eps_dots more_dropdown">
                                                                                <a href="#" className="oiv-dropdown-button">
                                                                                    ⋮
                                                                        ...
                                                                        <p className="oiv-cmnt_text_message">Fusce lacinia, nunc sit amet tincidunt venenatis.</p>
                                                                        <div className="oiv-contact_icon">
                                                                            <a href="#" className="oiv-report"><img src={like} />4</a>
                                                                            <a href="#" className="oiv-report"><img src={dislike} /> 2</a>
                                                                            <a href="#" className="oiv-report"><img src={heart} /></a>
                                                                            <a href="#" className="oiv-report ml-3">Reply</a>
                                                                        </div>
                                                                    </div>
