  ...
  return (
    <div className="sa4d25">
      <div className="container-fluid">
            ...
            <div className="section3125 stream_tabs">
              <ul className="nav nav-tabs slive_tabs justify-content-center" id="myTab" role="tablist">
                <li className="nav-item">
                  <div
                    className={`nav-link ${activeTab === 'add-streaming' ? 'active' : ''}`}
              ...
              <div className="tab-content" id="myTabContent">
                {activeTab === 'add-streaming' && (
                  <div className="tab-pane fade show active" id="add-streaming" role="tabpanel">
                    ...
                    <div className="live_form">
                      ...
                      <div className="input-group">
                          ...
                          />
                          <button className="_6tf7s red-button" type="button" value="1">Copy</button>
                        </div>
                      </div>
                        <div className="group-form">
        ...
        />
        <label htmlFor="stream_ss1">Publish this as a continuous live video</label>
      </div>
      ...
      <div className="ui toggle checkbox _1457s2">
        ...
        />
        <label htmlFor="stream_ss3">Unpublish after live video ends</label>
      </div>
      ...
      <div className="ui toggle checkbox _1457s2">
        ...
        />
        <label htmlFor="stream_ss4">Allow viewers to rewind</label>
      </div>
      ...
      <div className="ui toggle checkbox">
        ...
        />
        <label htmlFor="stream_ss5">End broadcast when stream ends</label>
      </div>
      ...
      <div className="ui toggle checkbox _1457s2">
        ...
        />
        <label htmlFor="stream_ss6">Publish as a test broadcast</label>
      </div>
      ...
      <div className="ui toggle checkbox _1457s2">
        ...
        />
        <label htmlFor="stream_ss7">Turn off live commentary</label>
      </div>
