...
<div className="RH-container">
    <h2 className="RH-st_title"><img src={RPH} alt='' className="Check-iocn"  /> Report history</h2>
    <div className="RH-grid-container">
        <div className="RH-report_history">
            ...
            <a href="#" className="RH-lnk586">Learn more about reporting content on Cursus.</a>
