                                            ...
                                            <div className="group_messages">
                                                <div className="chat__message__dt active">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-text">Hi! Sir, How are you. I ask you one thing please explain it this video price.</p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Kerstin Cable</span></p>
                                                        <p className="user-status-text">Hello, I paid you video tutorial but did not play error 404.</p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Jose Portilla</span></p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Farhat Amin</span></p>
                                                        <p className="user-status-text">Hi! Sir, this is a purchase key CFKX12536ERUJSKLL</p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Kyle Pew</span></p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Eli Natoli</span></p>
                                                        <p className="user-status-text">Hi Sir thank you very very much for bootstrap full course.</p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Jaysen Batchelor</span></p>
                                                ...
                                                <div className="chat__message__dt">
                                                    <div className="user-status">
                                                        ...
                                                        <p className="user-status-title"><span className="bold">Quinton Batchelor</span></p>
