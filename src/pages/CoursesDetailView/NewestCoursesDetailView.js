...
import { fetchNewestCourseDetailRequest } from "../../redux/reduxActions/coursesDetailActions/newestCoursesDetailAction";

const NewestCoursesDetailView = () => {
  const sections = [
    {
    ...
    },
    {
      ...
      lectures: [
        ...
        {
          title: "Setting Up Front-End Developer Environment",
          summary: "03:11",
          icon: "uil-play-circle",
        },
        {
          title: "Note about Introduction to the Web",
          summary: "00:11",
          icon: "uil-file",
        },
        {
        ...
        {
          title: "The Front End Holy Trinity",
          summary: "11:46",
          icon: "uil-play-circle",
          preview: true,
        },
    ...
    },
    {
      ...
      lectures: [
        ...
        {
          title: "HTML Basics and Setting Up Front-End Developer Environment",
          summary: "05:53",
          icon: "uil-play-circle",
        },
        {
          title: "Note about Introduction to MDN",
          summary: "00:19",
          icon: "uil-file",
        },
        {
          title: "Introduction to MDN",
          summary: "01:51",
          icon: "uil-play-circle",
        },
        {
          title: "HTML Boilerplate and Comments",
          summary: "09:42",
          icon: "uil-play-circle",
        },
        ...
        {
          title: "HTML Lists Assignment",
          summary: "01:23",
          icon: "uil-play-circle",
        },
        {
          title: "HTML Lists Assignment: SOLUTION",
          summary: "05:59",
          icon: "uil-play-circle",
        },
        ...
        {
          title: "Recreate Webpage Assignment",
          summary: "01:00",
          icon: "uil-play-circle",
        },
        {
          title: "Recreate Webpage Assignment: SOLUTION",
          summary: "03:56",
          icon: "uil-play-circle",
        },
      ],
    },
    {
      ...
      lectures: [
        ...
        {
          title: "Dropdowns and Radio Buttons",
          summary: "11:19",
          icon: "uil-play-circle",
        },
    ...
    },
    {
      ...
      lectures: [
        ...
        {
          title: "Note about Selectors Basics Todo List",
          summary: "00:32",
          icon: "uil-file",
        },
        {
          title: "Selectors Basics Todo List",
          summary: "10:43",
          icon: "uil-play-circle",
        },
        {
          title: "Introduction to Chrome Inspector",
          summary: "05:43",
          icon: "uil-play-circle",
        },
        {
          title: "More Advanced Selectors",
          summary: "09:23",
          icon: "uil-play-circle",
        },
        {
          title: "Note about Specificity and the Cascade",
          summary: "00:23",
          icon: "uil-file",
        },
        {
        ...
        {
          title: "Note about Selectors Practice Exercise",
          summary: "00:22",
          icon: "uil-file",
        },
        {
          title: "Selectors Practice Exercise",
          summary: "04:28",
          icon: "uil-play-circle",
        },
        {
          title: "Selectors Practice Exercise: SOLUTION",
          summary: "16:48",
          icon: "uil-play-circle",
        },
      ],
    },
    {
      ...
      lectures: [
        ...
        {
          title: "Creating a Tic Tac Toe Board",
          summary: "01:41",
          icon: "uil-play-circle",
        },
        {
          title: "Creating a Tic Tac Toe Board: SOLUTION",
          summary: "07:43",
          icon: "uil-play-circle",
        },
        {
          title: "Note about Image Gallery Code Along Pt. 1",
          summary: "00:20",
          icon: "uil-file",
        },
        {
          title: "Image Gallery Code Along Pt. 1",
          summary: "08:20",
          icon: "uil-play-circle",
        },
        {
          title: "Note about changes to Google Fonts",
          summary: "00:40",
          icon: "uil-file",
        },
        {
          title: "Image Gallery Code Along Pt. 2",
          summary: "05:46",
          icon: "uil-play-circle",
        },
        {
          title: "CSS Blog From Scratch Exercise Intro",
          summary: "03:23",
          icon: "uil-play-circle",
        },
        {
          title: "CSS Blog From Scratch Exercise SOLUTION Pt. 1",
          summary: "08:38",
          icon: "uil-play-circle",
        },
        {
          title: "CSS Blog From Scratch Exercise SOLUTION Pt. 2",
          summary: "08:12",
          icon: "uil-file",
        },
        {
          title: "CSS Blog From Scratch Exercise SOLUTION Pt. 3",
          summary: "07:28",
          icon: "uil-play-circle",
        },
      ],
    },
    {
      ...
      lectures: [
        { title: "Unit Objectives", summary: "02:28", icon: "uil-play-circle" },
        {
          title: "Note about Bootstrap versions",
          summary: "00:44",
          icon: "uil-file",
        },
        {
        ...
        {
          title: "Adding Bootstrap to a Project",
          summary: "09:15",
          icon: "uil-play-circle",
        },
        {
        ...
        {
          title: "Note about The Grid System",
          summary: "00:11",
          icon: "uil-file",
        },
        { title: "The Grid System", summary: "08:43", icon: "uil-play-circle" },
        {
          title: "Grid System Pt. 2",
          summary: "11:43",
          icon: "uil-play-circle",
        },
        {
          title: "Note about Bootstrap Image Gallery Pt. 1",
          summary: "00:55",
          icon: "uil-file",
        },
        {
          title: "Bootstrap Image Gallery Pt. 1",
          summary: "14:20",
          icon: "uil-play-circle",
        },
        {
          title: "Note about Font Awesome",
          summary: "00:16",
          icon: "uil-file",
        },
        {
          title: "Bootstrap Image Gallery Pt. 2",
          summary: "09:46",
          icon: "uil-play-circle",
        },
        {
          title: "Creating a Startup Landing Page Code Along",
          summary: "14:23",
          icon: "uil-play-circle",
        },
        {
          title: "Creating a Startup Landing Page Code Along Pt. 2",
          summary: "10:30",
          icon: "uil-play-circle",
        },
        {
          title: "Note about making bootstrap responsive on mobile devices",
          summary: "00:14",
          icon: "uil-file",
        },
      ],
    },
    {
      ...
      lectures: [
        {
          title: "A History of Bootstrap 4",
          summary: "04:40",
          icon: "uil-play-circle",
        },
        {
          title: "The Bootstrap 4 Documentation",
          summary: "02:24",
          icon: "uil-play-circle",
        },
        {
          title: "Changes from Bootstrap 3 to 4",
          summary: "07:52",
          icon: "uil-play-circle",
        },
        {
          title: "Bootstrap 4 Code/Solutions Download",
          summary: "00:41",
          icon: "uil-file",
        },
        {
          title: "Getting Started With Bootstrap 4",
          summary: "05:15",
          icon: "uil-play-circle",
        },
        {
          title: "Bootstrap 4 Colors and Backgrounds",
          summary: "05:59",
          icon: "uil-play-circle",
        },
        { title: "Typography", summary: "11:12", icon: "uil-play-circle" },
        {
          title: "New Fancy Spacing Utilities",
          summary: "12:28",
          icon: "uil-play-circle",
        },
        {
        ...
        {
          title: "Bootstrap4 Navbars",
          summary: "08:20",
          icon: "uil-play-circle",
        },
        {
          title: "The New Display Utility",
          summary: "07:26",
          icon: "uil-play-circle",
        },
        {
          title: "Bootstrap 4: Flexbox and Layout",
          summary: "10:14",
          icon: "uil-play-circle",
        },
        {
          title: "Flexbox Utilities Part 2",
          summary: "07:23",
          icon: "uil-play-circle",
        },
        {
          title: "Navs and Flexbox",
          summary: "09:56",
          icon: "uil-play-circle",
        },
        {
          title: "The Bootstrap 4 Grid",
          summary: "08:56",
          icon: "uil-play-circle",
        },
        {
          title: "PATTERN PROJECT Part 1",
          summary: "12:06",
          icon: "uil-play-circle",
        },
        {
          title: "PATTERN PROJECT Part 2",
          summary: "11:30",
          icon: "uil-play-circle",
        },
        {
          title: "The Grid + Flexbox",
          summary: "11:44",
          icon: "uil-play-circle",
        },
        {
        ...
        {
          title: "Note about Museum of Candy Project Part 2",
          summary: "00:12",
          icon: "uil-file",
        },
      ],
    },
    {
      ...
      lectures: [
        ...
        {
          title: "Useful Built-In Methods",
          summary: "05:12",
          icon: "uil-play-circle",
        },
        {
          title: "Writing JavaScript in a Separate File",
          summary: "04:28",
          icon: "uil-play-circle",
        },
        {
          title: "JS Stalker Exercise",
          summary: "01:55",
          icon: "uil-play-circle",
        },
        {
          title: "JS Stalker Exercise: SOLUTION",
          summary: "04:45",
          icon: "uil-play-circle",
        },
        {
          title: "Age Calculator Exercise",
          summary: "01:10",
          icon: "uil-play-circle",
        },
        {
          title: "Age Calculator Exercise: SOLUTION",
          summary: "04:01",
          icon: "uil-play-circle",
        },
      ],
  ...
  const { newestCourses } = useSelector((state) => state.newestCoursesDetail);
  ...
  if (!newestCourses) return <div>Course not found</div>;
  return (
    <div>
                ...
                <div className="courses_detail_view-row2">
                  <div className="courses_detail_view-box1">
                    <div className="cdv-preview_video">
                      <a href="#" className="fcrse_img">
                        <img
                          src={newestCourses.newest_courses_detail?.imgSrc}
                          alt=""
                        />
                        <div className="cdv-course-overlay">
                          ...
                          <span className="cdv-label-preview-this-course">
                            Preview this course
                          </span>
                        </div>
                      </a>
                  ...
                  <div className="courses_detail_view-box2">
                    <div className="cdv-label1">
                      <h2>{newestCourses.newest_courses_detail?.title}</h2>
                      <span className="cdv-label2">
                        {
                          newestCourses.newest_courses_detail
                            .information_courses
                        }
                      </span>
                    </div>
                    <div className="cdv-rate_star">
                      <div className="crse_reviews mr-2">
                        ...
                        {newestCourses.newest_courses_detail?.rating}
                      </div>
                      ({newestCourses.newest_courses_detail?.ratingCount.toLocaleString()}{" "}
                      ratings)
                    </div>
                    <div className="cdv-rate_star">
                      {newestCourses.newest_courses_detail?.enrollCount.toLocaleString()} students
                      watching
                    </div>
                    ...
                    <div className="cdv-rate_star">Last updated 1/2024</div>
              ...
              <div className="cdv-user">
                <div className="cdv-user_dt">
                  <div className="cdv-live_user_dt">
                    <div className="cdv-user_img">
                      <a href="#">
                        <img
                          src={newestCourses.newest_courses_detail?.imgChannel}
                          alt=""
                        />
                      </a>
                    </div>
                    <div className="cdv-user_cntnt">
                      <a href="#" className="cdv-user-name">
                        {newestCourses.newest_courses_detail?.author}
                      </a>
                ...
                <div className="cdv-contact_icon">
                  <a href="#" className="cdv-report1">
                    <img src={eyes} />
                    <span>{newestCourses.newest_courses_detail?.viewCount}</span>
                  </a>
                  <a href="#" className="cdv-report1">
                    <img src={like} />
                    <span>{newestCourses.newest_courses_detail?.likeCount}</span>
                  </a>
                  <a href="#" className="cdv-report1">
                    <img src={dislike} />
                    <span>
                      {newestCourses.newest_courses_detail?.dislikeCount}
                    </span>
                  </a>
                  <a href="#" className="cdv-report1">
                    <img src={share} />
                    <span>
                      {newestCourses.newest_courses_detail?.shareCount}
                    </span>
                  </a>
                </div>
              </div>
              <div className="courses_detail_view_tabs">
                <div>
                  <div className="courses_detail_view-nav">
                    ...
                    <div
                      className={`tab ${oivtab === "reviews" ? "active" : ""}`}
                          ...
                          <div className="box-div-cdv">
                            <div className="cdv-label-requirement">
                              ...
                              <ul>
                                ...
                                <li>
                                  <span className="_5f7g11">
                                    Be ready to learn an insane amount of
                                    awesome stuff
                                  </span>
                                </li>
                                <li>
                            ...
                            <div className="cdv-label-description">
                              ...
                              <p>
                                ...
                                . There are a lot of options for online
                                developer training, but this course is without a
                                doubt the most comprehensive and effective on
                              ...
                              <ul className="_abc124">
                                ...
                                <li>
                                  <span className="_5f7g11">
                                    94% of my in-person bootcamp students go on
                                    to get full-time developer jobs. Most of
                                    them are complete beginners when I start
                                    working with them.
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    The previous 2 bootcamp programs that I
                                    taught cost $14,000 and $21,000. This course
                                    is just as comprehensive but with brand new
                                    content for a fraction of the price.
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    Everything I cover is up-to-date and
                                    relevant to today's developer industry. No
                                    PHP or other dated technologies. This course
                                    does not cut any corners.
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    This is the only complete beginner
                                    full-stack developer course that covers
                                    NodeJS.
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    ...
                                    production application called YelpCamp. No
                                    other course walks you through the creation
                                    of such a substantial application.
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    The course is constantly updated with new
                                    content, projects, and modules. Think of it
                                    as a subscription to a never-ending supply
                                    of developer training.
                                  </span>
                                </li>
                              </ul>
                              <p>
                                When you're learning to program you often have
                                to sacrifice learning the exciting and current
                                technologies in favor of the "beginner friendly"
                                classes. With this course, you get the best of
                                both worlds. This is a course designed for the
                                complete beginner, yet it covers some of the
                                most exciting and relevant topics in the
                                industry.
                              </p>
                              <p>
                              ...
                              <p>
                                ...
                                structured and presented. Many online courses
                                are just a long series of "watch as I code"
                                videos. This course is different. I've
                                incorporated everything I learned in my years of
                                teaching to make this course not only more
                                effective but more engaging. The course
                                includes:
                              </p>
                              <ul className="_abc124">
                                <li>
                              ...
                              <p>
                                ...
                                to contact me. I got into this industry because
                                I love working with people and helping students
                                learn. Sign up today and see how fun, exciting,
                              ...
                              <ul className="_abc124">
                                <li>
                                  <span className="_5f7g11">
                                    ...
                                    about web development, regardless of
                                    previous experience
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    It's perfect for complete beginners with
                                    zero experience
                                  </span>
                                </li>
                                <li>
                                  <span className="_5f7g11">
                                    It's also great for anyone who does have
                                    some experience in a few of the
                                  ...
                                  <ul className="_htg452 _abcd145">
                                    ...
                                    <li>
                                      <div className="_5f7g15">
                                        <i className="fas fa-check-circle"></i>
                                        <span>
                                          Donec ultricies elit porttitor,
                                          ultrices enim a, commodo dolor.
                                        </span>
                                      </div>
                                    </li>
                                    <li>
                                      <div className="_5f7g15">
                                        <i className="fas fa-check-circle"></i>
                                        <span>
                                          Nunc dapibus ligula sed justo porta,
                                          id volutpat odio iaculis.
                                        </span>
                                      </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <div className="_5f7g15">
                                        <i className="fas fa-check-circle"></i>
                                        <span>
                                          Praesent ac libero consequat,
                                          efficitur tortor et, interdum sem.
                                        </span>
                                      </div>
                                    </li>
                                    <li>
                                      <div className="_5f7g15">
                                        ...
                                        <span>
                                          ...
                                          Sed vitae tortor gravida, interdum
                                          felis at, pulvinar enim. Integer
                                          tempor urna leo.
                                        </span>
                                      </div>
                                    </li>
                                    <li>
                                      <div className="_5f7g15">
                                        ...
                                        <span>
                                          ...
                                          vestibulum. Curabitur aliquet dictum
                                          leo non congue.
                                        </span>
                                      </div>
                                    </li>
                          ...
                          <div className="cdv-accordion-box-label">
                            ...
                            <div className="cdv-accordion-label">
                              <div className="accordion-expand-holder">
                                <span className="accordion-expand-all _d1452">
                                  Expand all
                                </span>
                                      ...
                                      {section.lectures.map((lecture, idx) => (
                                        ...
                                        >
                                          <div className="left-content">
                                            <i
                                              className={`uil ${lecture.icon} icon_142`}
                                            ></i>
                                            <div className="top">
                                              <div className="title">
                                                {lecture.title}
...
export default NewestCoursesDetailView;
