...
const NewestCoursesDetailView = () => {
    ...
    if (!newestCourseDetail) return <div>Course not found</div>;
    return (
        <div>
                                ...
                                <div className="courses_detail_view-row2">
                                    ...
                                    <div className="courses_detail_view-box2">
                                        <div className="cdv-label1">
                                            <h2>{newestCourseDetail.title}</h2>
                                        ...
                                        <div className="cdv-rate_star">
                                            <div className="crse_reviews mr-2">
                                                <img className="starIcon" src={ratingStar}></img>{newestCourseDetail.rating}
                                            </div>
                                            (81,665 ratings)
                                        </div>
                                        <div className="cdv-rate_star">
                                            {newestCourseDetail.views} students watching
                                        </div>
