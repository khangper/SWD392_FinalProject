                        ...
                        <div className='CertificationFillForm_Sign_Form'>
                            ...
                            <form>
                                <div className='CertificationFillForm_Sign_Form_Input SFI40'>
                                    <input className="CertificationFillForm_srch_explore" type="text" name="fullname" id="id_fullname" required maxLength="64" placeholder="Full Name" />
                                </div>

                                <div className='CertificationFillForm_Sign_Form_Input SFI15'>
                                    <input className="CertificationFillForm_srch_explore" type="email" name="emailaddress" id="id_email" required maxLength="64" placeholder="Email Address" />
                                </div>

                                <div className='CertificationFillForm_Sign_Form_Input SFI15'>
                                    <input className="CertificationFillForm_srch_explore" type="text" name="phonenumber" id="id_phonenumber" required maxLength="10" placeholder="Phone Number" />
                                </div>
                                            ...
                                            <div className='Category_Cop_Items_Labels'>
                                                ...
                                                <label>
                                                    <input
                                                        ...
                                                        checked={selectedOption === "WordPress Elementor Pro"}
                                                        onChange={handleOptionChange}
                                                    />
                                ...
                                <p className="CertificationFillForm_questrm145">Please be ready to answer <span>20 questions</span> within <span>1 hours</span>.</p>
                            </form>
                        </div>
                    </div>
                </div>
