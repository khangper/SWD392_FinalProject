    ...
    <div className="CertificationCenterPage">
        ...
        <div className="CC-grid-container">
          <div className="CC-cert_banner_text CC-grid-item">
            ...
            <ul className="CC-certi_icons">
              ...
              <li>
                <a href="#" className="CC-edttslogo1">
                  <img
      ...
      <div className="CC_215xd5">
        ...
        <div className="CC1-grid-container">
          ...
          <div className="CC1-grid-item">
            <div className="ui search focus">
              <button className="CC-login-btn" type="submit">
                Find Certificate
              </button>
            </div>
          </div>
                  ...
                  <div className="CC-development">
                    <div className="CC-certificates">
                      <div className="CC3-grid-container">
                        <a href="#" className="CC-certilink__152">
                          WordPress
                        </a>
                        <a href="#" className="CC-certilink__152">
                          HTML CSS
        ...
        <div className="CC5-grid-container">
          <div className="CC-knowledge_dts">
            <p>
              ...
              dolor, non condimentum libero dolor vel ipsum. Sed porttitor nisi
              eget nulla ullamcorper eleifend. Fusce tristique sapien nisi, vel
              feugiat neque luctus sit amet. Quisque consequat quis turpis in
              mattis. Maecenas eget mollis nisl. Cras porta dapibus est, quis
              malesuada ex iaculis at. Vestibulum egestas tortor in urna tempor,
              in fermentum lectus bibendum. In leo leo, bibendum at pharetra at,
              tincidunt in nulla. In vel malesuada nulla, sed tincidunt neque.
              Phasellus at massa vel sem aliquet sodales non in magna. Ut tempus
              ipsum sagittis neque cursus euismod. Vivamus luctus elementum
              tortor, ac aliquet dolor vehicula et. Nulla vehicula pharetra
              lacus ornare gravida. Vivamus mollis ullamcorper dui quis gravida.
              Aenean pulvinar pulvinar arcu a suscipit.
            </p>
