            ...
            <form>
              <div className="grid-container">
                ...
                <div className="Gridcheckout-full">
                  ...
                  <select  className="selectpicker-checkout" 
  ...
  India
            ...
            <ul className="Select-custom-tabs-nav" role="tablist">
                <li className="Select-custom-tabs-item">
                    <a href="#credit-method-tab" className={activeTab === 'credit-method-tab' ? 'Select-custom-tabs-link active' : 'Select-custom-tabs-link'} onClick={() => openTab('credit-method-tab')}>
                        <i className="fa fa-credit-card"></i><br /> Credit/Debit Card
                    </a>
                </li>
                <li className="Select-custom-tabs-item">
                    <a href="#bank-method-tab" className={activeTab === 'bank-method-tab' ? 'Select-custom-tabs-link active' : 'Select-custom-tabs-link'} onClick={() => openTab('bank-method-tab')}>
                        <i className="fa fa-university"></i><br /> Bank Transfer
                    </a>
                </li>
                <li className="Select-custom-tabs-item">
                    <a href="#paypal-method-tab" className={activeTab === 'paypal-method-tab' ? 'Select-custom-tabs-link active' : 'Select-custom-tabs-link'} onClick={() => openTab('paypal-method-tab')}>
                        <i className="fa fa-paypal"></i><br /> Paypal
                    </a>
                </li>
            </ul>

            <div className="custom-tabs-content">
                <div className={activeTab === 'credit-method-tab' ? 'Select-custom-tabs-pane active' : 'Select-custom-tabs-pane'} id="credit-method-tab">
    ...
    <div className="gg-grid-container">
        <div className="grid-item holder-card">
            <div className="ui search focus lbel25">
                ...
                <div className="ui left icon input swdh11 swdh19">
                    <input className="prompt srch_explore" type="text" name="holder[name]" id="id_holdername" required  onChange={handleChange}  placeholder="Enter Holder Name" />
                </div>
            </div>
        </div>
        <div className="grid-item holder-card">
            <div className="ui search focus lbel25">
                ...
                <div className="ui left icon input swdh11 swdh19">
                    <input className="prompt srch_explore" type="text" name="card[number]"   onChange={handleChange} placeholder="Card #" />
                </div>
            </div>
        </div>
        </div>
  ...
  <div className="grid-item expiration">
    ...
    <div className="item">
        <div className="ui search focus mt-30 lbel25">
            ...
            <div className="ui left icon input swdh11 swdh19">
                <input className="prompt srch_explore" type="text" name="account[holdername]" value="" required=""       onChange={handleChange} placeholder="Enter Your Full Name"/>															
            </div>
        </div>										
    </div>
    <div className="item">
        <div className="ui search focus mt-30 lbel25">
            ...
            <div className="ui left icon input swdh11 swdh19">														
                <input className="prompt srch_explore" type="text" name="Account[number]"      onChange={handleChange}  placeholder="Enter Account Number"/>									
            </div>
        </div>												
    </div>
    <div className="item">
        <div className="lbel25 mt-30">
            ...
            <select className="ui hj145 dropdown cntry152 prompt srch_explore" name="Bank[name]" onChange={handleChange}>
    ...
    <div className="item">
        <div className="ui search focus mt-30 lbel25">
            ...
            <div className="ui left icon input swdh11 swdh19">	
                <input className="prompt srch_explore" type="text" name="IFSC[code]"      onChange={handleChange} placeholder="Enter IFSC Code"/>
            </div>
        </div>
    </div>
</form>
                </div>
                <div className={activeTab === 'paypal-method-tab' ? 'Select-custom-tabs-pane active' : 'Select-custom-tabs-pane'} id="paypal-method-tab">
            ...
            <div className="media__body">
                <ul id="paypal-gateway" className="financial-institutes">
                    <li className="financial-institutes__logo">
                        <img alt="Visa" title="Visa" src="https://gambolthemes.net/html-items/cursus-new-demo/images/membership/pyicon-1.svg"/>
                    </li>
                    <li className="financial-institutes__logo">
                        <img alt="MasterCard" title="MasterCard" src="https://gambolthemes.net/html-items/cursus-new-demo/images/membership/pyicon-2.svg"/>
                    </li>
                    <li className="financial-institutes__logo">
                        <img alt="American Express" title="American Express" src="https://gambolthemes.net/html-items/cursus-new-demo/images/membership/pyicon-3.svg"/>
                    </li>
                    <li className="financial-institutes__logo">
                        <img alt="Discover" title="Discover" src="https://gambolthemes.net/html-items/cursus-new-demo/images/membership/pyicon-4.svg"/>
                    </li>
                    <li className="financial-institutes__logo">
                        <img alt="China UnionPay" title="China UnionPay" src="https://gambolthemes.net/html-items/cursus-new-demo/images/membership/pyicon-5.svg"/>
                    </li>
                </ul>
            </div>
        </div>
